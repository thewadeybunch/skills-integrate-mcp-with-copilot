...
1. Open the new pull request created by Copilot in a new tab.
   ...
   [![Examine the pull request](https://img.shields.io/badge/-Open%20Pull%20Request-1f883d?logo=github)](https://github.com/thewadeybunch/skills-integrate-mcp-with-copilot/pull/11)
